...
import com.fisc.declspectacle.DeclspectacleApp;
...
@SpringBootTest(classes = DeclspectacleApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class DeclspectacleKafkaResourceIT {
    ...
    @Autowired
    private DeclspectacleKafkaProducer producer;

    @Autowired
    private DeclspectacleKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        DeclspectacleKafkaResource kafkaResource = new DeclspectacleKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/declspectacle-kafka/publish?message=test"))
